...
function Register() {
  ...
  */
  ...
  /*
  =====================================
  SEARCH WITHIN MATCHING SUBJECTS
  =====================================
  */
  ...
  const filteredSubjects =
    useMemo(() => {
      ...
      if (!keyword) {
        return academicFilteredSubjects;
      }

      return academicFilteredSubjects.filter(
        (subject) => {
          const searchable =
            [
  ...
  const handleChange = (
    ...
    setFormData(
      (previousData) => {
        ...
        /*
        -------------------------------------
        Academic dependency reset
        -------------------------------------

        When course/year/semester changes,
        previously selected irregular subjects
                                    ...
                                    <div className="flex flex-wrap gap-2 self-start sm:self-center">
                                      <span className="rounded-full bg-slate-100 px-3 py-1 text-xs font-black text-slate-600">
                                        {subjectSearch.trim()
                                          ...
                                          : `${academicFilteredSubjects.length} available`}
                                      </span>
